...
@section('content')
    ...
    <div class="container">
        ...
        @endif
        <a href="{{ route('publisher.create', ['company_id' => $companyID]) }}" class="btn btn-primary"
            style="float:right;">{{ __('Add New Publisher') }}</a>
        <div class="card card-body col-sm-7" style="margin-bottom: 20px">
            <form class="form-inline" action="{{ route('publisher.list', ['company_id' => $companyID]) }}">
        ...
        <div class="table-container">
            <div class="table-responsive">
                <table class="table table-hover" id='publisher_list_table'>
                    <thead>
                        <tr>
                            <th data-field="id" data-sortable="true" scope="col">Publisher Id <i class="fa fa-sort"></i>
                            </th>
                            <th data-field="name" data-sortable="true" scope="col">Publisher Name <i
                                    class="fa fa-sort"></i></th>
                            <th data-field="email" data-sortable="true" scope="col">Publisher Email <i
                                    class="fa fa-sort"></i></th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete_camp_confirm').on('click', function() {
                ...
                var request = $.ajax({
                    url: "/" + companyID + "/publisher/" + publisher_id,
                    type: "DELETE",
                    dataType: "json",
                    data: {
