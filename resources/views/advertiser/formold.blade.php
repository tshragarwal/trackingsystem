            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('advertiser.formsave', ['company_id' => $companyID]) }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ $advertizer['name'] ?? old('name') }}" required autocomplete="name"
                                        autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="manual_email" type="text"
                                        ...
                                        value="{{ $advertizer['manual_email'] ?? old('manual_email') }}" autocomplete="name"
                                        autofocus>
