...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card card-body" style="margin-bottom: 20px; overflow:visible;">
            <form action="{{ route('report.list', ['company_id' => $companyID, 'type' => 'n2s']) }}" method='get'>
                <div class="row">
                    ...
                    @if (!empty($publisher_advertizer_list) && !empty($publisher_advertizer_list['publisher_list']))
                        ...
                        <input type="hidden" id="publishers_id" name="publishers_id" value="{{ $query_string['publishers_id'] ?? '' }}">
                    @endif
                    ...
                    <div class="col-md-12 col-lg-4" style="margin-top: 22px">
                        ...
                        <a href="{{ route('report.list', ['company_id' => $companyID, 'type' => 'n2s']) }}" class="btn btn-danger">Reset</a>
                    </div>
                </div>
            </form>
        </div>
        <div style="margin-bottom: 20px;text-align: end;">
            <form action="{{ route('report.downloadcsv', ['company_id' => $companyID]) }}" method='get'>
                <div class="row">
                    <div class="col">
                        ...
                        @if (Auth::guard('web')->user()->user_type == 'admin')
                            <a href="{{ route('report.upload', ['company_id' => $companyID, 'type' => 'n2s']) }}" class="btn btn-primary">
                                {{ __('UPLOAD REPORT') }} </a> 
                            <a href="#" data-toggle="modal"
                                data-target="#deletAllReport" class="btn btn-danger delete_report">
                                {{ __('DELETE REPORT') }} </a>
                        @endif
                    </div>
                </div>
                        ...
                        <tr>
                            @if ($adminFlag == true)
                                ...
                                <th data-field="subid" data-sortable="true" scope="col">Advertiser Subid <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="searches" data-sortable="true" scope="col">Searches <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="clicks" data-sortable="true" scope="col">Clicks <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="tq" data-sortable="true" scope="col">TQ <i class="fa fa-sort"></i>
                                </th>
                                <th data-field="ctr" data-sortable="true" scope="col">CTR (in %) <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="adv_cpc" data-sortable="true" scope="col">Advertiser CPC ($) <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="adv_rpm" data-sortable="true" scope="col">Advertiser RPM ($) <i
                                        class="fa fa-sort"></i></th>
                                ...
                                <th data-field="pub_id" data-sortable="true" scope="col">Publisher Id <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="offer_id" data-sortable="true" scope="col">Offer Id <i
                                        class="fa fa-sort"></i></th>
                            ...
                            @else
                                <th data-field="date" data-sortable="true" scope="col">Date <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_offer_id" data-sortable="true" scope="col">Offer Id <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_country" data-sortable="true" scope="col">Country <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_total_search" data-sortable="true" scope="col">Total Searches <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_add_clicks" data-sortable="true" scope="col">Ad Clicks <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_ctr" data-sortable="true" scope="col">CTR (in %) <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_rpc" data-sortable="true" scope="col">RPC ($) <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_rpm" data-sortable="true" scope="col">RPM ($) <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_net_revenue" data-sortable="true" scope="col">Net Revenue ($) <i
                                        class="fa fa-sort"></i></th>
                                <th data-field="p_tq" data-sortable="true" scope="col">TQ <i class="fa fa-sort"></i>
                                </th>
                            @endif
                        </tr>
                    </thead>
                            ...
                            @foreach ($data as $record)
                                <tr class="n2s_{{ $record->id }}">
                                    @if ($adminFlag == true)
                                        ...
                                        <td scope="row">
                                            <a
                                                href="{{ route('report.edit', ['company_id' => $companyID, 'type' => 'n2s', 'id' => $record->id]) }}"><i
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.delete_all_report_confirm').on('click', function() {
                var token = $('meta[name="csrf-token"]').attr('content');
                var request = $.ajax({
                    url: '/' + companyID + '/report/n2s/flush-data',
                    type: "DELETE",
                    dataType: "json",
                    data: {
